...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 05, 2019 at 08:55 AM
...
('G01', 'Sakit kepala'),
('G02', 'Pusing'),
('G03', 'Pendarahan dari hidung'),
('G04', 'Wajah kemerahan'),
('G05', 'Mudah lelah'),
('G06', 'Penglihatan kabur'),
('G07', 'Mual berlebihan'),
('G08', 'Keringat berlebihan'),
('G09', 'Mengigau'),
('G10', 'Nyeri pada bagian badan'),
('G11', 'Denyut jantung tidak teratur'),
('G12', 'Pembengkakan pada kaki dan perut'),
('G13', 'Cepat haus'),
('G14', 'Sering buang air kecil'),
('G15', 'Penurunan berat badan'),
('G16', 'Kurang aktivitas'),
('G17', 'Berat badan berlebih'),
('G18', 'Lemak berlebih'),
('G19', 'Mudah mengantuk'),
('G20', 'Sakit atau pegal di kepala bagian belakang'),
('G21', 'Sakit lutut'),
('G22', 'Varises'),
('G23', 'Sulit bernafas'),
('G24', 'Sendi terasa nyeri'),
('G25', 'Meradang pada sendi'),
('G26', 'Kaku pada persendian'),
('G27', 'Benjolan-benjolan di sekitar sendi yang terasa nyeri'),
('G28', 'Susah buang air kecil'),
('G29', 'Nafsu makan menurun'),
('G30', 'Pucat'),
('G31', 'Keram pada bagian perut'),
('G32', 'Sering merasa anemia'),
('G33', 'Verrrt');
...
('P02', 'Jantung'),
('P03', 'Diabetes'),
('P04', 'Kolesterol tinggi'),
('P05', 'Kolesterol darah'),
('P06', 'Obesitas'),
('P07', 'Asam urat'),
('P08', 'Ginjal');
...
(3, 'yuliana kusuma wardani', 'yuliana', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'Admin', 1, '2019-08-03 15:14:12'),
(5, 'yulia', 'nanana', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'Admin', 1, '2019-08-03 15:15:25'),
(6, 'bambang ', 'bambang tri', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'Pakar', 1, '2019-08-03 15:15:26'),
(7, 'test gannnnn', 'admin123', '$2y$10$SWtYcUj33Ebe/57jpmH82eDODENDHiijb3qBNvbHDLcDeoWEBxd1u', 'Admin', 1, '2019-08-03 15:59:34'),
(8, 'test gannnnn juga', 'pakar123', '$2y$10$SWtYcUj33Ebe/57jpmH82eDODENDHiijb3qBNvbHDLcDeoWEBxd1u', 'Pakar', 1, '2019-08-03 15:59:34'),
(9, 'tes pengguna', 'pengguna1', '601f1889667efaebb33b8c12572835da3f027f78', 'Pakar', 1, '2019-08-04 15:08:55');
