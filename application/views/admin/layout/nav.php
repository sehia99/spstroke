      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('admin/user') ?>"><i class="fa fa-table"></i> Data Member</a></li>
            <li><a href="<?php echo base_url('admin/user/tambah') ?>"><i class="fa fa-plus"></i> Tambah Member </a></li>
          </ul>
        </li>
        ...
        <!-- <li class="treeview"> -->
          ...
          <!-- <ul class="treeview-menu"> -->
            <!-- <li><a href="<?php echo base_url('admin/penyakit') ?>"><i class="fa fa-table"></i> Data Penyakit</a></li> -->
            <!-- <li><a href="<?php echo base_url('admin/penyakit/tambah') ?>"><i class="fa fa-plus"></i> Tambah Penyakit </a></li>-->
          <!-- </ul> -->
        <!-- </li> -->
