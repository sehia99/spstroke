<head>
    <title>Sistem Pakar &mdash; Stroke</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/template/css/owl.theme.default.min.css">
        <link href="<?php echo base_url(); ?>assets/template/css/multi-select.css" media="screen" rel="stylesheet" type="text/css">
        <script src="<?php echo base_url(); ?>assets/template/js/jquery.multi-select.js" type="text/javascript"></script>
